...
<div class="wrap cls">
        ...
        <?php
            ...
            $settings = wp_parse_args( $settings, array( 'controller' => get_current_user_ID(), 'apps' => array(), 'roles' => array() ) );
            ...
            if( !empty( $users ) ):
                basefield(array(
                    ...
                    'label' => __('Choose your trusted administrators.'),
                    'choices' => $users
                ));
            endif; 
            ...
            $apps = array(
                ...
                'woocommerce' => '<span class="dashicons dashicons-cart"></span> '. __('Woocommerce') .
                        '<p class="description">Allows you to control your product\'s visibility and change your users capabilities.</p>',
            );
            $apps = apply_filters( "cls_apps", $apps );
            
            printf('<h3>%s</h3>', __('Because you are in control, you choose which to activate.' ) );
            basefield(array(
                'type' => 'checkbox',
        ...
        <div id="cls-capabilities" class="cls-tab-content">
            ...
            <div id="cap-<?php _e($role); ?>" class="cls-inner-tab">
                ...
                do_action( "cls_capabilities", $role );
                ?>
            </div>
            <?php endforeach; ?>
            <div class="clear"></div>
